...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getCommentaireControllerService()
    {
        ...
        return $this->services['App\\Controller\\CommentaireController'] = new \App\Controller\CommentaireController();
    }
    ...
    /**
     * Gets the private '.service_locator.j.btmxC' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_J_BtmxCService()
    {
        return $this->privates['.service_locator.j.btmxC'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\CategorieCrudController', 1 => 'App\\Controller\\Admin\\FilmCrudController', 2 => 'App\\Controller\\Admin\\PubliciteCrudController', 3 => 'App\\Controller\\Admin\\SalleDeProjectionCrudController']);
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/salledeprojection'), [0 => 'ROLE_USER'], NULL);
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder9dcfc = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer747fb = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties6ca4a = [
        
    ];

    public function getConnection()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getConnection', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getMetadataFactory', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getExpressionBuilder', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'beginTransaction', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getCache', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getCache();
    }

    public function transactional($func)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'transactional', array('func' => $func), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->transactional($func);
    }

    public function commit()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'commit', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->commit();
    }

    public function rollback()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'rollback', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getClassMetadata', array('className' => $className), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'createQuery', array('dql' => $dql), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'createNamedQuery', array('name' => $name), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'createQueryBuilder', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'flush', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'clear', array('entityName' => $entityName), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->clear($entityName);
    }

    public function close()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'close', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->close();
    }

    public function persist($entity)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'persist', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'remove', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'refresh', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'detach', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'merge', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getRepository', array('entityName' => $entityName), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'contains', array('entity' => $entity), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getEventManager', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getConfiguration', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'isOpen', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getUnitOfWork', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getProxyFactory', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'initializeObject', array('obj' => $obj), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'getFilters', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'isFiltersStateClean', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'hasFilters', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return $this->valueHolder9dcfc->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer747fb = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder9dcfc) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder9dcfc = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder9dcfc->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, '__get', ['name' => $name], $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        if (isset(self::$publicProperties6ca4a[$name])) {
            return $this->valueHolder9dcfc->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder9dcfc;
    ...
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;
    ...
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, '__isset', array('name' => $name), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;
    ...
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, '__unset', array('name' => $name), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;
    ...
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, '__clone', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        $this->valueHolder9dcfc = clone $this->valueHolder9dcfc;
    }

    public function __sleep()
    {
        $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, '__sleep', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;

        return array('valueHolder9dcfc');
    }
    ...
    {
        $this->initializer747fb = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer747fb;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer747fb && ($this->initializer747fb->__invoke($valueHolder9dcfc, $this, 'initializeProxy', array(), $this->initializer747fb) || 1) && $this->valueHolder9dcfc = $valueHolder9dcfc;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder9dcfc;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder9dcfc;
    }
}
